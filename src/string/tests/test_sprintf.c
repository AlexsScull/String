...
TEST_SPRINTF_1(test_s21_sprintf_o_min_pl, "unsigned int: %o", 0 - 1, unsigned int)
TEST_SPRINTF_1(test_s21_sprintf_o_max, "unsigned int: %o", UINT_MAX, unsigned int)
TEST_SPRINTF_1(test_s21_sprintf_o_max_pl, "unsigned int: %o", UINT_MAX + 1, unsigned int)
...
TEST_SPRINTF_1(test_s21_sprintf_u_min_pl, "unsigned int: %u", 0 - 1, unsigned int)
TEST_SPRINTF_1(test_s21_sprintf_u_max, "unsigned int: %u", UINT_MAX, unsigned int)
TEST_SPRINTF_1(test_s21_sprintf_u_max_pl, "unsigned int: %u", UINT_MAX + 1, unsigned int)
...
TEST_SPRINTF_1(test_s21_sprintf_x_min_pl, "unsigned int: %x", 0 - 1, unsigned int)
TEST_SPRINTF_1(test_s21_sprintf_x_max, "unsigned int: %x", UINT_MAX, unsigned int)
TEST_SPRINTF_1(test_s21_sprintf_x_max_pl, "unsigned int: %x", UINT_MAX + 1, unsigned int)
...
TEST_SPRINTF_1(test_s21_sprintf_ho_min, "unsigned short: %ho", 0, unsigned short)
TEST_SPRINTF_1(test_s21_sprintf_ho_min_pl, "unsigned short : %ho", 0 - 1, unsigned short)
TEST_SPRINTF_1(test_s21_sprintf_ho_max, "unsigned short : %ho", USHRT_MAX, unsigned short)
TEST_SPRINTF_1(test_s21_sprintf_ho_max_pl, "unsigned short : %ho", USHRT_MAX + 1, unsigned short)
TEST_SPRINTF_1(test_s21_sprintf_ho_false_tupe, "unsigned short : %ho", 'A', double)
TEST_SPRINTF_1(test_s21_sprintf_ho_null, "unsigned short : %ho", NULL, unsigned short)

// %hu - unsigned short
TEST_SPRINTF_1(test_s21_sprintf_hu, "unsigned short : %hu", 123, unsigned short)
TEST_SPRINTF_1(test_s21_sprintf_hu_min, "unsigned short : %hu", 0, unsigned short)
TEST_SPRINTF_1(test_s21_sprintf_hu_min_pl, "unsigned short : %hu", 0 - 1, unsigned short)
TEST_SPRINTF_1(test_s21_sprintf_hu_max, "unsigned short : %hu", USHRT_MAX, unsigned short)
TEST_SPRINTF_1(test_s21_sprintf_hu_max_pl, "unsigned short : %hu", USHRT_MAX + 1, unsigned short)
TEST_SPRINTF_1(test_s21_sprintf_hu_false_tupe, "unsigned short : %hu", 'A', double)
TEST_SPRINTF_1(test_s21_sprintf_hu_null, "unsigned short : %hu", NULL, unsigned short)

// %hx - unsigned short
TEST_SPRINTF_1(test_s21_sprintf_hx, "unsigned short : %hx", 123, unsigned short)
TEST_SPRINTF_1(test_s21_sprintf_hx_min, "unsigned short : %hx", 0, unsigned short)
TEST_SPRINTF_1(test_s21_sprintf_hx_min_pl, "unsigned short : %hx", 0 - 1, unsigned short)
TEST_SPRINTF_1(test_s21_sprintf_hx_max, "unsigned short : %hx", USHRT_MAX, unsigned short)
TEST_SPRINTF_1(test_s21_sprintf_hx_max_pl, "unsigned short : %hx", USHRT_MAX + 1, unsigned short)
TEST_SPRINTF_1(test_s21_sprintf_hx_false_tupe, "unsigned short : %hx", 'A', double)
TEST_SPRINTF_1(test_s21_sprintf_hx_null, "unsigned short : %hx", NULL, unsigned short)
...
TEST_SPRINTF_1(test_s21_sprintf_hhd_min, "signed char: %hhd", SCHAR_MIN, signed char)
TEST_SPRINTF_1(test_s21_sprintf_hhd_min_pl, "signed char: %hhd", SCHAR_MIN - 1, signed char)
TEST_SPRINTF_1(test_s21_sprintf_hhd_max, "signed char: %hhd", SCHAR_MAX, signed char)
TEST_SPRINTF_1(test_s21_sprintf_hhd_max_pl, "signed char: %hhd", SCHAR_MAX + 1, signed char)
TEST_SPRINTF_1(test_s21_sprintf_hhd_false_tupe, "signed char: %hhd", 'A', double)
TEST_SPRINTF_1(test_s21_sprintf_hhd_null, "signed char: %hhd", NULL, signed char)

// %hhi - signed char
TEST_SPRINTF_1(test_s21_sprintf_hhi, "signed char: %hhi", 123, signed char)
TEST_SPRINTF_1(test_s21_sprintf_hhi_min, "signed char: %hhi", SCHAR_MIN, signed char)
TEST_SPRINTF_1(test_s21_sprintf_hhi_min_pl, "signed char: %hhi", SCHAR_MIN - 1, signed char)
TEST_SPRINTF_1(test_s21_sprintf_hhi_max, "signed char: %hhi", SCHAR_MAX, signed char)
TEST_SPRINTF_1(test_s21_sprintf_hhi_max_pl, "signed char: %hhi", SCHAR_MAX + 1, signed char)
TEST_SPRINTF_1(test_s21_sprintf_hhi_false_tupe, "signed char: %hhi", 'A', double)
TEST_SPRINTF_1(test_s21_sprintf_hhi_null, "signed char: %hhi", NULL, signed char)

// %hho - unsigned char
TEST_SPRINTF_1(test_s21_sprintf_hho, "unsigned char: %hho", 123, unsigned char)
TEST_SPRINTF_1(test_s21_sprintf_hho_min, "unsigned char: %hho", 0, unsigned char)
TEST_SPRINTF_1(test_s21_sprintf_hho_min_pl, "unsigned char : %hho", 0 - 1, unsigned char)
TEST_SPRINTF_1(test_s21_sprintf_hho_max, "unsigned char : %hho", UCHAR_MAX, unsigned char)
TEST_SPRINTF_1(test_s21_sprintf_hho_max_pl, "unsigned char : %hho", UCHAR_MAX + 1, unsigned char)
TEST_SPRINTF_1(test_s21_sprintf_hho_false_tupe, "unsigned char : %hho", 'A', double)
TEST_SPRINTF_1(test_s21_sprintf_hho_null, "unsigned char : %hho", NULL, unsigned char)

// %hhu - unsigned char
TEST_SPRINTF_1(test_s21_sprintf_hhu, "unsigned char : %hhu", 123, unsigned char)
TEST_SPRINTF_1(test_s21_sprintf_hhu_min, "unsigned char : %hhu", 0, unsigned char)
TEST_SPRINTF_1(test_s21_sprintf_hhu_min_pl, "unsigned char : %hhu", 0 - 1, unsigned char)
TEST_SPRINTF_1(test_s21_sprintf_hhu_max, "unsigned char : %hhu", UCHAR_MAX, unsigned char)
TEST_SPRINTF_1(test_s21_sprintf_hhu_max_pl, "unsigned char : %hhu", UCHAR_MAX + 1, unsigned char)
TEST_SPRINTF_1(test_s21_sprintf_hhu_false_tupe, "unsigned char : %hhu", 'A', double)
TEST_SPRINTF_1(test_s21_sprintf_hhu_null, "unsigned char : %hhu", NULL, unsigned char)

// %hhx - unsigned char
TEST_SPRINTF_1(test_s21_sprintf_hhx, "unsigned char : %hhx", 123, unsigned char)
TEST_SPRINTF_1(test_s21_sprintf_hhx_min, "unsigned char : %hhx", 0, unsigned char)
TEST_SPRINTF_1(test_s21_sprintf_hhx_min_pl, "unsigned char : %hhx", 0 - 1, unsigned char)
TEST_SPRINTF_1(test_s21_sprintf_hhx_max, "unsigned char : %hhx", UCHAR_MAX, unsigned char)
TEST_SPRINTF_1(test_s21_sprintf_hhx_max_pl, "unsigned char : %hhx", UCHAR_MAX + 1, unsigned char)
TEST_SPRINTF_1(test_s21_sprintf_hhx_false_tupe, "unsigned char : %hhx", 'A', double)
TEST_SPRINTF_1(test_s21_sprintf_hhx_null, "unsigned char : %hhx", NULL, unsigned char)
...
TEST_SPRINTF_1(test_s21_sprintf_lo_min_pl, "unsigned long : %lo", 0 - 1, unsigned long)
TEST_SPRINTF_1(test_s21_sprintf_lo_max, "unsigned long : %lo", ULONG_MAX, unsigned long)
TEST_SPRINTF_1(test_s21_sprintf_lo_max_pl, "unsigned long : %lo", ULONG_MAX + 1, unsigned long)
TEST_SPRINTF_1(test_s21_sprintf_lo_false_tupe, "unsigned long : %lo", 'A', double)
TEST_SPRINTF_1(test_s21_sprintf_lo_null, "unsigned long : %lo", NULL, unsigned long)
...
TEST_SPRINTF_1(test_s21_sprintf_lu_min_pl, "unsigned long : %lu", 0 - 1, unsigned long)
TEST_SPRINTF_1(test_s21_sprintf_lu_max, "unsigned long : %lu", ULONG_MAX, unsigned long)
TEST_SPRINTF_1(test_s21_sprintf_lu_max_pl, "unsigned long : %lu", ULONG_MAX + 1, unsigned long)
TEST_SPRINTF_1(test_s21_sprintf_lu_false_tupe, "unsigned long : %lu", 'A', double)
TEST_SPRINTF_1(test_s21_sprintf_lu_null, "unsigned long : %lu", NULL, unsigned long)
...
TEST_SPRINTF_1(test_s21_sprintf_lx_min_pl, "unsigned long : %lx", 0 - 1, unsigned long)
TEST_SPRINTF_1(test_s21_sprintf_lx_max, "unsigned long : %lx", ULONG_MAX, unsigned long)
TEST_SPRINTF_1(test_s21_sprintf_lx_max_pl, "unsigned long : %lx", ULONG_MAX + 1, unsigned long)
TEST_SPRINTF_1(test_s21_sprintf_lx_false_tupe, "unsigned long : %lx", 'A', double)
TEST_SPRINTF_1(test_s21_sprintf_lx_null, "unsigned long : %lx", NULL, unsigned long)

// %lX - unsigned long
TEST_SPRINTF_1(test_s21_sprintf_lX, "unsigned long : %lX", 123, unsigned long)
TEST_SPRINTF_1(test_s21_sprintf_lX_min, "unsigned long : %lX", 0, unsigned long)
TEST_SPRINTF_1(test_s21_sprintf_lX_min_pl, "unsigned long : %lX", 0 - 1, unsigned long)
TEST_SPRINTF_1(test_s21_sprintf_lX_max, "unsigned long : %lX", USHRT_MAX, unsigned long)
TEST_SPRINTF_1(test_s21_sprintf_lX_max_pl, "unsigned long : %lX", USHRT_MAX + 1, unsigned long)
TEST_SPRINTF_1(test_s21_sprintf_lX_false_tupe, "unsigned long : %lX", 'A', double)
TEST_SPRINTF_1(test_s21_sprintf_lX_null, "unsigned long : %lX", NULL, unsigned long)
...
TEST_SPRINTF_1(test_s21_sprintf_lld_min, "long long: %lld", LLONG_MIN, long long)
TEST_SPRINTF_1(test_s21_sprintf_lld_min_pl, "long long: %lld", LLONG_MIN - 1, long long)
TEST_SPRINTF_1(test_s21_sprintf_lld_max, "long long: %lld", LLONG_MAX, long long)
TEST_SPRINTF_1(test_s21_sprintf_lld_max_pl, "long long: %lld", LLONG_MAX + 1, long long)
...
TEST_SPRINTF_1(test_s21_sprintf_lli_min, "long long: %lli", LLONG_MIN, long long)
TEST_SPRINTF_1(test_s21_sprintf_lli_min_pl, "long long: %lli", LLONG_MIN - 1, long long)
TEST_SPRINTF_1(test_s21_sprintf_lli_max, "long long: %lli", LLONG_MAX, long long)
TEST_SPRINTF_1(test_s21_sprintf_lli_max_pl, "long long: %lli", LLONG_MAX + 1, long long)
...
TEST_SPRINTF_1(test_s21_sprintf_llo, "unsigned long long: %llo", 123, unsigned long long)
TEST_SPRINTF_1(test_s21_sprintf_llo_min, "unsigned long long: %llo", 0, unsigned long long)
TEST_SPRINTF_1(test_s21_sprintf_llo_min_pl, "unsigned long long: %llo", 0 - 1, unsigned long long)
TEST_SPRINTF_1(test_s21_sprintf_llo_max, "unsigned long long: %llo", ULLONG_MAX, unsigned long long)
TEST_SPRINTF_1(test_s21_sprintf_llo_max_pl, "unsigned long long: %llo", ULLONG_MAX + 1, unsigned long long)
TEST_SPRINTF_1(test_s21_sprintf_llo_false_tupe, "unsigned long long: %llo", 'A', double)
TEST_SPRINTF_1(test_s21_sprintf_llo_null, "unsigned long long: %llo", NULL, unsigned long long)

// %llu - unsigned long long
TEST_SPRINTF_1(test_s21_sprintf_llu, "unsigned long long: %llu", 123, unsigned long long)
TEST_SPRINTF_1(test_s21_sprintf_llu_min, "unsigned long long: %llu", 0, unsigned long long)
TEST_SPRINTF_1(test_s21_sprintf_llu_min_pl, "unsigned long long: %llu", 0 - 1, unsigned long long)
TEST_SPRINTF_1(test_s21_sprintf_llu_max, "unsigned long long: %llu", ULLONG_MAX, unsigned long long)
TEST_SPRINTF_1(test_s21_sprintf_llu_max_pl, "unsigned long long: %llu", ULLONG_MAX + 1, unsigned long long)
TEST_SPRINTF_1(test_s21_sprintf_llu_false_tupe, "unsigned long long: %llu", 'A', double)
TEST_SPRINTF_1(test_s21_sprintf_llu_null, "unsigned long long: %llu", NULL, unsigned long long)

// %llx - unsigned long long
TEST_SPRINTF_1(test_s21_sprintf_llx, "unsigned long long: %llx", 123, unsigned long long)
TEST_SPRINTF_1(test_s21_sprintf_llx_min, "unsigned long long: %llx", 0, unsigned long long)
TEST_SPRINTF_1(test_s21_sprintf_llx_min_pl, "unsigned long long: %llx", 0 - 1, unsigned long long)
TEST_SPRINTF_1(test_s21_sprintf_llx_max, "unsigned long long: %llx", ULLONG_MAX, unsigned long long)
TEST_SPRINTF_1(test_s21_sprintf_llx_max_pl, "unsigned long long: %llx", ULLONG_MAX + 1, unsigned long long)
TEST_SPRINTF_1(test_s21_sprintf_llx_false_tupe, "unsigned long long: %llx", 'A', double)
TEST_SPRINTF_1(test_s21_sprintf_llx_null, "unsigned long long: %llx", NULL, unsigned long long)
...
TEST_SPRINTF_1(test_s21_sprintf_s_special_chars, "String: %s", "Line1\nLine2\tTab\x01", char*)
...
// %g - double
TEST_SPRINTF_1(test_s21_sprintf_g_switch_to_e, "double: %g", 0.0000123456, double)
...
TEST_SPRINTF_1(test_s21_sprintf_Le_neg, "long double: %Le", -123.456L, long double)
...
TEST_SPRINTF_1(test_s21_sprintf_Lf_prec, "long double: %.3Lf", 123.456789L, long double)

// %Lg - long double
TEST_SPRINTF_1(test_s21_sprintf_Lg, "long double: %Lg", 123.456L, long double)
TEST_SPRINTF_1(test_s21_sprintf_Lg_small, "long double: %Lg", 0.0000123456L, long double)
...
// %Le - long double
TEST_SPRINTF_1(test_s21_sprintf_Le_nan, "long double: %Le", (long double)NAN, long double)
TEST_SPRINTF_1(test_s21_sprintf_Le_inf, "long double: %Le", (long double)INFINITY, long double)
TEST_SPRINTF_1(test_s21_sprintf_Le_neg_inf, "long double: %Le", (long double)(-INFINITY), long double)
...
// %Lf - long double
TEST_SPRINTF_1(test_s21_sprintf_Lf_nan, "long double: %Lf", (long double)NAN, long double)
TEST_SPRINTF_1(test_s21_sprintf_Lf_inf, "long double: %Lf", (long double)INFINITY, long double)
TEST_SPRINTF_1(test_s21_sprintf_Lf_neg_inf, "long double: %Lf", (long double)(-INFINITY), long double)

// %Lg - long double
TEST_SPRINTF_1(test_s21_sprintf_Lg_nan, "long double: %Lg", (long double)NAN, long double)
TEST_SPRINTF_1(test_s21_sprintf_Lg_inf, "long double: %Lg", (long double)INFINITY, long double)
TEST_SPRINTF_1(test_s21_sprintf_Lg_neg_inf, "long double: %Lg", (long double)(-INFINITY), long double)
...
TEST_SPRINTF_1(test_s21_sprintf_p_unsigned_int, "Pointer: %p", (unsigned int*)0x1234abcd, unsigned int*)
TEST_SPRINTF_1(test_s21_sprintf_p_double, "Pointer: %p", (double*)0x1234abcd, double*)
