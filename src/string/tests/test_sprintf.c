...
TEST_SPRINTF(test_s21_sprintf_u_width_prec_minus_negt, "%-10.5u", -123,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_width_prec_minus_post, "%-10.5u", 123,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_width_prec_minus_zero, "%-10.5u", 0,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_width_prec_minus_ng_z, "%-10.5u", -0,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_width_prec_plus_negt, "%+10.5u", -123,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_width_prec_plus_post, "%+10.5u", 123,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_width_prec_plus_zero, "%+10.5u", 0,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_width_prec_plus_ng_z, "%+10.5u", -0,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_width_prec_space_negt, "% 10.5u", -123,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_width_prec_space_post, "% 10.5u", 123,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_width_prec_space_zero, "% 10.5u", 0,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_width_prec_space_ng_z, "% 10.5u", -0,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_width_prec_hash_negt, "%#10.5u", -123,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_width_prec_hash_post, "%#10.5u", 123,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_width_prec_hash_zero, "%#10.5u", 0,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_width_prec_hash_ng_z, "%#10.5u", -0,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_width_prec_zero_negt, "%010.5u", -123,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_width_prec_zero_post, "%010.5u", 123,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_width_prec_zero_zero, "%010.5u", 0,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_width_prec_zero_ng_z, "%010.5u", -0,
             unsigned int)

TEST_SPRINTF_2(test_s21_sprintf_u_dynamic_width, "%*u", 10, 123, unsigned int)
TEST_SPRINTF_2(test_s21_sprintf_u_dynamic_precision, "%.*u", 5, 123,
               unsigned int)
...
TEST_SPRINTF(test_s21_sprintf_u_zero_prec_zero_negt, "%0.0u", -123,
             unsigned int)
...
TEST_SPRINTF(test_s21_sprintf_u_zero_prec_zero_minus_zero, "%-0.0u", 0,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_zero_prec_zero_plus_zero, "%+0.0u", 0,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_zero_prec_zero_space_zero, "% 0.0u", 0,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_zero_prec_zero_hash_zero, "%#0.0u", 0,
             unsigned int)
TEST_SPRINTF(test_s21_sprintf_u_zero_prec_width_zero_zero, "%00.0u", 0,
             unsigned int)
...
TEST_SPRINTF(test_s21_sprintf_f_width_prec_minus_negt, "%-10.5f", -123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_f_width_prec_minus_post, "%-10.5f", 123.456,
             double)
...
TEST_SPRINTF(test_s21_sprintf_f_width_prec_plus_negt, "%+10.5f", -123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_f_width_prec_plus_post, "%+10.5f", 123.456,
             double)
...
TEST_SPRINTF(test_s21_sprintf_f_width_prec_space_negt, "% 10.5f", -123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_f_width_prec_space_post, "% 10.5f", 123.456,
             double)
...
TEST_SPRINTF(test_s21_sprintf_f_width_prec_hash_negt, "%#10.5f", -123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_f_width_prec_hash_post, "%#10.5f", 123.456,
             double)
...
TEST_SPRINTF(test_s21_sprintf_f_width_prec_zero_negt, "%010.5f", -123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_f_width_prec_zero_post, "%010.5f", 123.456,
             double)
...
TEST_SPRINTF_3(test_s21_sprintf_f_dynamic_width_precision, "%*.*f", 10, 5,
               123.456, double)
...
// Тесты для %e
TEST_SPRINTF(test_s21_sprintf_e_minus_negt, "%-e", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_minus_post, "%-e", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_minus_zero_, "%-e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_minus_ng_z, "%-e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_plus_negt, "%+e", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_plus_post, "%+e", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_plus_zero, "%+e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_plus_ng_z, "%+e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_space_negt, "% e", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_space_post, "% e", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_space_zero, "% e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_space_ng_z, "% e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_hash_negt, "%#e", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_hash_post, "%#e", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_hash_zero, "%#e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_hash_ng_z, "%#e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_negt, "%0e", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_post, "%0e", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_zero, "%0e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_ng_z, "%0e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_minus_negt, "%-5e", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_width_minus_post, "%-5e", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_width_minus_zero, "%-5e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_minus_ng_z, "%-5e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_plus_negt, "%+5e", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_width_plus_post, "%+5e", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_width_plus_zero, "%+5e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_plus_ng_z, "%+5e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_space_negt, "% 5e", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_width_space_post, "% 5e", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_width_space_zero, "% 5e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_space_ng_z, "% 5e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_hash_negt, "%#5e", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_width_hash_post, "%#5e", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_width_hash_zero, "%#5e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_hash_ng_z, "%#5e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_zero_negt, "%05e", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_width_zero_post, "%05e", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_width_zero_zero, "%05e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_zero_ng_z, "%05e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_minus_negt, "%-.5e", -1123.45623, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_minus_post, "%-.5e", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_minus_zero, "%-.5e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_minus_ng_z, "%-.5e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_plus_negt, "%+.5e", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_plus_post, "%+.5e", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_plus_zero, "%+.5e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_plus_ng_z, "%+.5e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_space_negt, "% .5e", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_space_post, "% .5e", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_space_zero, "% .5e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_space_ng_z, "% .5e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_hash_negt, "%#.5e", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_hash_post, "%#.5e", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_hash_zero, "%#.5e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_hash_ng_z, "%#.5e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_zero_negt, "%0.5e", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_zero_post, "%0.5e", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_zero_zero, "%0.5e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_zero_ng_z, "%0.5e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_minus_negt, "%-10.5e", -123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_minus_post, "%-10.5e", 123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_minus_zero, "%-10.5e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_minus_ng_z, "%-10.5e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_plus_negt, "%+10.5e", -123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_plus_post, "%+10.5e", 123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_plus_zero, "%+10.5e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_plus_ng_z, "%+10.5e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_space_negt, "% 10.5e", -123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_space_post, "% 10.5e", 123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_space_zero, "% 10.5e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_space_ng_z, "% 10.5e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_hash_negt, "%#10.5e", -123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_hash_post, "%#10.5e", 123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_hash_zero, "%#10.5e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_hash_ng_z, "%#10.5e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_zero_negt, "%010.5e", -123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_zero_post, "%010.5e", 123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_zero_zero, "%010.5e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_zero_ng_z, "%010.5e", -0, double)
TEST_SPRINTF_2(test_s21_sprintf_e_dynamic_width, "%*e", 10, 123.456, double)
TEST_SPRINTF_2(test_s21_sprintf_e_dynamic_precision, "%.*e", 5, 123.456, double)
TEST_SPRINTF_3(test_s21_sprintf_e_dynamic_width_precision, "%*.*e", 10, 5,
               123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_width_negt, "%5e", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_width_post, "%5e", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_width_zero, "%5e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_ng_z, "%5e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_negt, "%.5e", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_post, "%.5e", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_zero_, "%.5e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_prec_ng_z, "%.5e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_negt, "%10.5e", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_post, "%10.5e", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_zero, "%10.5e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_width_prec_ng_z, "%10.5e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_prec_negt, "%.0e", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_prec_post, "%.0e", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_prec_zero, "%.0e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_prec_ng_z, "%.0e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_zero_negt, "%0e", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_zero_post, "%0e", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_zero_zero, "%0e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_zero_ng_z, "%0e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_prec_zero_negt, "%0.0e", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_prec_zero_post, "%0.0e", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_prec_zero_zero, "%0.0e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_prec_zero_ng_z, "%0.0e", -0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_prec_minus_zero, "%-.0e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_prec_plus_zero, "%+.0e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_prec_space_zero, "% .0e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_prec_hash_zero, "%#.0e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_zero_minus_zero, "%-0e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_zero_plus_zero, "%+0e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_zero_space_zero, "% 0e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_zero_hash_zero, "%#0e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_width_zero_zero, "%00e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_prec_zero_minus_zero, "%-0.0e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_prec_zero_plus_zero, "%+0.0e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_prec_zero_space_zero, "% 0.0e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_prec_zero_hash_zero, "%#0.0e", 0, double)
TEST_SPRINTF(test_s21_sprintf_e_zero_prec_width_zero_zero, "%00.0e", 0, double)
...
// Тесты для %e
TEST_SPRINTF(test_s21_sprintf_g_minus_negt, "%-g", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_minus_post, "%-g", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_minus_zero_, "%-g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_minus_ng_z, "%-g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_plus_negt, "%+g", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_plus_post, "%+g", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_plus_zero, "%+g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_plus_ng_z, "%+g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_space_negt, "% g", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_space_post, "% g", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_space_zero, "% g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_space_ng_z, "% g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_hash_negt, "%#g", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_hash_post, "%#g", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_hash_zero, "%#g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_hash_ng_z, "%#g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_negt, "%0g", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_post, "%0g", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_zero, "%0g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_ng_z, "%0g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_minus_negt, "%-5g", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_width_minus_post, "%-5g", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_width_minus_zero, "%-5g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_minus_ng_z, "%-5g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_plus_negt, "%+5g", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_width_plus_post, "%+5g", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_width_plus_zero, "%+5g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_plus_ng_z, "%+5g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_space_negt, "% 5g", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_width_space_post, "% 5g", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_width_space_zero, "% 5g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_space_ng_z, "% 5g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_hash_negt, "%#5g", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_width_hash_post, "%#5g", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_width_hash_zero, "%#5g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_hash_ng_z, "%#5g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_zero_negt, "%05g", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_width_zero_post, "%05g", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_width_zero_zero, "%05g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_zero_ng_z, "%05g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_minus_negt, "%-.5g", -1123.45623, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_minus_post, "%-.5g", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_minus_zero, "%-.5g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_minus_ng_z, "%-.5g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_plus_negt, "%+.5g", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_plus_post, "%+.5g", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_plus_zero, "%+.5g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_plus_ng_z, "%+.5g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_space_negt, "% .5g", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_space_post, "% .5g", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_space_zero, "% .5g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_space_ng_z, "% .5g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_hash_negt, "%#.5g", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_hash_post, "%#.5g", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_hash_zero, "%#.5g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_hash_ng_z, "%#.5g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_zero_negt, "%0.5g", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_zero_post, "%0.5g", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_zero_zero, "%0.5g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_zero_ng_z, "%0.5g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_minus_negt, "%-10.5g", -123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_minus_post, "%-10.5g", 123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_minus_zero, "%-10.5g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_minus_ng_z, "%-10.5g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_plus_negt, "%+10.5g", -123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_plus_post, "%+10.5g", 123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_plus_zero, "%+10.5g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_plus_ng_z, "%+10.5g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_space_negt, "% 10.5g", -123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_space_post, "% 10.5g", 123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_space_zero, "% 10.5g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_space_ng_z, "% 10.5g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_hash_negt, "%#10.5g", -123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_hash_post, "%#10.5g", 123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_hash_zero, "%#10.5g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_hash_ng_z, "%#10.5g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_zero_negt, "%010.5g", -123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_zero_post, "%010.5g", 123.456,
             double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_zero_zero, "%010.5g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_zero_ng_z, "%010.5g", -0, double)
TEST_SPRINTF_2(test_s21_sprintf_g_dynamic_width, "%*g", 10, 123.456, double)
TEST_SPRINTF_2(test_s21_sprintf_g_dynamic_precision, "%.*g", 5, 123.456, double)
TEST_SPRINTF_3(test_s21_sprintf_g_dynamic_width_precision, "%*.*g", 10, 5,
               123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_width_negt, "%5g", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_width_post, "%5g", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_width_zero, "%5g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_ng_z, "%5g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_negt, "%.5g", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_post, "%.5g", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_zero_, "%.5g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_prec_ng_z, "%.5g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_negt, "%10.5g", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_post, "%10.5g", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_zero, "%10.5g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_width_prec_ng_z, "%10.5g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_prec_negt, "%.0g", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_prec_post, "%.0g", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_prec_zero, "%.0g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_prec_ng_z, "%.0g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_zero_negt, "%0g", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_zero_post, "%0g", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_zero_zero, "%0g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_zero_ng_z, "%0g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_prec_zero_negt, "%0.0g", -123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_prec_zero_post, "%0.0g", 123.456, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_prec_zero_zero, "%0.0g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_prec_zero_ng_z, "%0.0g", -0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_prec_minus_zero, "%-.0g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_prec_plus_zero, "%+.0g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_prec_space_zero, "% .0g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_prec_hash_zero, "%#.0g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_zero_minus_zero, "%-0g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_zero_plus_zero, "%+0g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_zero_space_zero, "% 0g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_zero_hash_zero, "%#0g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_width_zero_zero, "%00g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_prec_zero_minus_zero, "%-0.0g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_prec_zero_plus_zero, "%+0.0g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_prec_zero_space_zero, "% 0.0g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_prec_zero_hash_zero, "%#0.0g", 0, double)
TEST_SPRINTF(test_s21_sprintf_g_zero_prec_width_zero_zero, "%00.0g", 0, double)
...
Suite *sprintf_suite(void) {
  ...
  tcase_add_test(tc, test_s21_sprintf_e_minus_negt);
  tcase_add_test(tc, test_s21_sprintf_e_minus_post);
  tcase_add_test(tc, test_s21_sprintf_e_minus_zero_);
  tcase_add_test(tc, test_s21_sprintf_e_minus_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_plus_negt);
  tcase_add_test(tc, test_s21_sprintf_e_plus_post);
  tcase_add_test(tc, test_s21_sprintf_e_plus_zero);
  tcase_add_test(tc, test_s21_sprintf_e_plus_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_space_negt);
  tcase_add_test(tc, test_s21_sprintf_e_space_post);
  tcase_add_test(tc, test_s21_sprintf_e_space_zero);
  tcase_add_test(tc, test_s21_sprintf_e_space_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_hash_negt);
  tcase_add_test(tc, test_s21_sprintf_e_hash_post);
  tcase_add_test(tc, test_s21_sprintf_e_hash_zero);
  tcase_add_test(tc, test_s21_sprintf_e_hash_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_zero_negt);
  tcase_add_test(tc, test_s21_sprintf_e_zero_post);
  tcase_add_test(tc, test_s21_sprintf_e_zero_zero);
  tcase_add_test(tc, test_s21_sprintf_e_zero_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_width_minus_negt);
  tcase_add_test(tc, test_s21_sprintf_e_width_minus_post);
  tcase_add_test(tc, test_s21_sprintf_e_width_minus_zero);
  tcase_add_test(tc, test_s21_sprintf_e_width_minus_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_width_plus_negt);
  tcase_add_test(tc, test_s21_sprintf_e_width_plus_post);
  tcase_add_test(tc, test_s21_sprintf_e_width_plus_zero);
  tcase_add_test(tc, test_s21_sprintf_e_width_plus_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_width_space_negt);
  tcase_add_test(tc, test_s21_sprintf_e_width_space_post);
  tcase_add_test(tc, test_s21_sprintf_e_width_space_zero);
  tcase_add_test(tc, test_s21_sprintf_e_width_space_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_width_hash_negt);
  tcase_add_test(tc, test_s21_sprintf_e_width_hash_post);
  tcase_add_test(tc, test_s21_sprintf_e_width_hash_zero);
  tcase_add_test(tc, test_s21_sprintf_e_width_hash_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_width_zero_negt);
  tcase_add_test(tc, test_s21_sprintf_e_width_zero_post);
  tcase_add_test(tc, test_s21_sprintf_e_width_zero_zero);
  tcase_add_test(tc, test_s21_sprintf_e_width_zero_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_prec_minus_negt);
  tcase_add_test(tc, test_s21_sprintf_e_prec_minus_post);
  tcase_add_test(tc, test_s21_sprintf_e_prec_minus_zero);
  tcase_add_test(tc, test_s21_sprintf_e_prec_minus_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_prec_plus_negt);
  tcase_add_test(tc, test_s21_sprintf_e_prec_plus_post);
  tcase_add_test(tc, test_s21_sprintf_e_prec_plus_zero);
  tcase_add_test(tc, test_s21_sprintf_e_prec_plus_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_prec_space_negt);
  tcase_add_test(tc, test_s21_sprintf_e_prec_space_post);
  tcase_add_test(tc, test_s21_sprintf_e_prec_space_zero);
  tcase_add_test(tc, test_s21_sprintf_e_prec_space_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_prec_hash_negt);
  tcase_add_test(tc, test_s21_sprintf_e_prec_hash_post);
  tcase_add_test(tc, test_s21_sprintf_e_prec_hash_zero);
  tcase_add_test(tc, test_s21_sprintf_e_prec_hash_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_prec_zero_negt);
  tcase_add_test(tc, test_s21_sprintf_e_prec_zero_post);
  tcase_add_test(tc, test_s21_sprintf_e_prec_zero_zero);
  tcase_add_test(tc, test_s21_sprintf_e_prec_zero_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_minus_negt);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_minus_post);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_minus_zero);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_minus_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_plus_negt);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_plus_post);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_plus_zero);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_plus_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_space_negt);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_space_post);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_space_zero);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_space_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_hash_negt);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_hash_post);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_hash_zero);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_hash_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_zero_negt);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_zero_post);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_zero_zero);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_zero_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_dynamic_width);
  tcase_add_test(tc, test_s21_sprintf_e_dynamic_precision);
  tcase_add_test(tc, test_s21_sprintf_e_dynamic_width_precision);
  tcase_add_test(tc, test_s21_sprintf_e_width_negt);
  tcase_add_test(tc, test_s21_sprintf_e_width_post);
  tcase_add_test(tc, test_s21_sprintf_e_width_zero);
  tcase_add_test(tc, test_s21_sprintf_e_width_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_prec_negt);
  tcase_add_test(tc, test_s21_sprintf_e_prec_post);
  tcase_add_test(tc, test_s21_sprintf_e_prec_zero_);
  tcase_add_test(tc, test_s21_sprintf_e_prec_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_negt);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_post);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_zero);
  tcase_add_test(tc, test_s21_sprintf_e_width_prec_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_zero_prec_negt);
  tcase_add_test(tc, test_s21_sprintf_e_zero_prec_post);
  tcase_add_test(tc, test_s21_sprintf_e_zero_prec_zero);
  tcase_add_test(tc, test_s21_sprintf_e_zero_prec_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_zero_zero_negt);
  tcase_add_test(tc, test_s21_sprintf_e_zero_zero_post);
  tcase_add_test(tc, test_s21_sprintf_e_zero_zero_zero);
  tcase_add_test(tc, test_s21_sprintf_e_zero_zero_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_zero_prec_zero_negt);
  tcase_add_test(tc, test_s21_sprintf_e_zero_prec_zero_post);
  tcase_add_test(tc, test_s21_sprintf_e_zero_prec_zero_zero);
  tcase_add_test(tc, test_s21_sprintf_e_zero_prec_zero_ng_z);
  tcase_add_test(tc, test_s21_sprintf_e_zero_prec_minus_zero);
  tcase_add_test(tc, test_s21_sprintf_e_zero_prec_plus_zero);
  tcase_add_test(tc, test_s21_sprintf_e_zero_prec_space_zero);
  tcase_add_test(tc, test_s21_sprintf_e_zero_prec_hash_zero);
  tcase_add_test(tc, test_s21_sprintf_e_zero_zero_minus_zero);
  tcase_add_test(tc, test_s21_sprintf_e_zero_zero_plus_zero);
  tcase_add_test(tc, test_s21_sprintf_e_zero_zero_space_zero);
  tcase_add_test(tc, test_s21_sprintf_e_zero_zero_hash_zero);
  tcase_add_test(tc, test_s21_sprintf_e_zero_width_zero_zero);
  tcase_add_test(tc, test_s21_sprintf_e_zero_prec_zero_minus_zero);
  tcase_add_test(tc, test_s21_sprintf_e_zero_prec_zero_plus_zero);
  tcase_add_test(tc, test_s21_sprintf_e_zero_prec_zero_space_zero);
  tcase_add_test(tc, test_s21_sprintf_e_zero_prec_zero_hash_zero);
  tcase_add_test(tc, test_s21_sprintf_e_zero_prec_width_zero_zero);
  tcase_add_test(tc, test_s21_sprintf_E_minus_negt);
  tcase_add_test(tc, test_s21_sprintf_E_minus_post);
  tcase_add_test(tc, test_s21_sprintf_E_minus_zero_);
  tcase_add_test(tc, test_s21_sprintf_E_minus_ng_z);
  ...
  tcase_add_test(tc, test_s21_sprintf_E_zero_prec_zero_hash_zero);
  tcase_add_test(tc, test_s21_sprintf_E_zero_prec_width_zero_zero);
  tcase_add_test(tc, test_s21_sprintf_g_minus_negt);
  tcase_add_test(tc, test_s21_sprintf_g_minus_post);
  tcase_add_test(tc, test_s21_sprintf_g_minus_zero_);
  tcase_add_test(tc, test_s21_sprintf_g_minus_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_plus_negt);
  tcase_add_test(tc, test_s21_sprintf_g_plus_post);
  tcase_add_test(tc, test_s21_sprintf_g_plus_zero);
  tcase_add_test(tc, test_s21_sprintf_g_plus_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_space_negt);
  tcase_add_test(tc, test_s21_sprintf_g_space_post);
  tcase_add_test(tc, test_s21_sprintf_g_space_zero);
  tcase_add_test(tc, test_s21_sprintf_g_space_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_hash_negt);
  tcase_add_test(tc, test_s21_sprintf_g_hash_post);
  tcase_add_test(tc, test_s21_sprintf_g_hash_zero);
  tcase_add_test(tc, test_s21_sprintf_g_hash_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_zero_negt);
  tcase_add_test(tc, test_s21_sprintf_g_zero_post);
  tcase_add_test(tc, test_s21_sprintf_g_zero_zero);
  tcase_add_test(tc, test_s21_sprintf_g_zero_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_width_minus_negt);
  tcase_add_test(tc, test_s21_sprintf_g_width_minus_post);
  tcase_add_test(tc, test_s21_sprintf_g_width_minus_zero);
  tcase_add_test(tc, test_s21_sprintf_g_width_minus_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_width_plus_negt);
  tcase_add_test(tc, test_s21_sprintf_g_width_plus_post);
  tcase_add_test(tc, test_s21_sprintf_g_width_plus_zero);
  tcase_add_test(tc, test_s21_sprintf_g_width_plus_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_width_space_negt);
  tcase_add_test(tc, test_s21_sprintf_g_width_space_post);
  tcase_add_test(tc, test_s21_sprintf_g_width_space_zero);
  tcase_add_test(tc, test_s21_sprintf_g_width_space_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_width_hash_negt);
  tcase_add_test(tc, test_s21_sprintf_g_width_hash_post);
  tcase_add_test(tc, test_s21_sprintf_g_width_hash_zero);
  tcase_add_test(tc, test_s21_sprintf_g_width_hash_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_width_zero_negt);
  tcase_add_test(tc, test_s21_sprintf_g_width_zero_post);
  tcase_add_test(tc, test_s21_sprintf_g_width_zero_zero);
  tcase_add_test(tc, test_s21_sprintf_g_width_zero_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_prec_minus_negt);
  tcase_add_test(tc, test_s21_sprintf_g_prec_minus_post);
  tcase_add_test(tc, test_s21_sprintf_g_prec_minus_zero);
  tcase_add_test(tc, test_s21_sprintf_g_prec_minus_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_prec_plus_negt);
  tcase_add_test(tc, test_s21_sprintf_g_prec_plus_post);
  tcase_add_test(tc, test_s21_sprintf_g_prec_plus_zero);
  tcase_add_test(tc, test_s21_sprintf_g_prec_plus_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_prec_space_negt);
  tcase_add_test(tc, test_s21_sprintf_g_prec_space_post);
  tcase_add_test(tc, test_s21_sprintf_g_prec_space_zero);
  tcase_add_test(tc, test_s21_sprintf_g_prec_space_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_prec_hash_negt);
  tcase_add_test(tc, test_s21_sprintf_g_prec_hash_post);
  tcase_add_test(tc, test_s21_sprintf_g_prec_hash_zero);
  tcase_add_test(tc, test_s21_sprintf_g_prec_hash_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_prec_zero_negt);
  tcase_add_test(tc, test_s21_sprintf_g_prec_zero_post);
  tcase_add_test(tc, test_s21_sprintf_g_prec_zero_zero);
  tcase_add_test(tc, test_s21_sprintf_g_prec_zero_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_minus_negt);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_minus_post);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_minus_zero);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_minus_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_plus_negt);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_plus_post);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_plus_zero);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_plus_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_space_negt);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_space_post);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_space_zero);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_space_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_hash_negt);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_hash_post);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_hash_zero);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_hash_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_zero_negt);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_zero_post);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_zero_zero);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_zero_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_dynamic_width);
  tcase_add_test(tc, test_s21_sprintf_g_dynamic_precision);
  tcase_add_test(tc, test_s21_sprintf_g_dynamic_width_precision);
  tcase_add_test(tc, test_s21_sprintf_g_width_negt);
  tcase_add_test(tc, test_s21_sprintf_g_width_post);
  tcase_add_test(tc, test_s21_sprintf_g_width_zero);
  tcase_add_test(tc, test_s21_sprintf_g_width_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_prec_negt);
  tcase_add_test(tc, test_s21_sprintf_g_prec_post);
  tcase_add_test(tc, test_s21_sprintf_g_prec_zero_);
  tcase_add_test(tc, test_s21_sprintf_g_prec_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_negt);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_post);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_zero);
  tcase_add_test(tc, test_s21_sprintf_g_width_prec_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_zero_prec_negt);
  tcase_add_test(tc, test_s21_sprintf_g_zero_prec_post);
  tcase_add_test(tc, test_s21_sprintf_g_zero_prec_zero);
  tcase_add_test(tc, test_s21_sprintf_g_zero_prec_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_zero_zero_negt);
  tcase_add_test(tc, test_s21_sprintf_g_zero_zero_post);
  tcase_add_test(tc, test_s21_sprintf_g_zero_zero_zero);
  tcase_add_test(tc, test_s21_sprintf_g_zero_zero_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_zero_prec_zero_negt);
  tcase_add_test(tc, test_s21_sprintf_g_zero_prec_zero_post);
  tcase_add_test(tc, test_s21_sprintf_g_zero_prec_zero_zero);
  tcase_add_test(tc, test_s21_sprintf_g_zero_prec_zero_ng_z);
  tcase_add_test(tc, test_s21_sprintf_g_zero_prec_minus_zero);
  tcase_add_test(tc, test_s21_sprintf_g_zero_prec_plus_zero);
  tcase_add_test(tc, test_s21_sprintf_g_zero_prec_space_zero);
  tcase_add_test(tc, test_s21_sprintf_g_zero_prec_hash_zero);
  tcase_add_test(tc, test_s21_sprintf_g_zero_zero_minus_zero);
  tcase_add_test(tc, test_s21_sprintf_g_zero_zero_plus_zero);
  tcase_add_test(tc, test_s21_sprintf_g_zero_zero_space_zero);
  tcase_add_test(tc, test_s21_sprintf_g_zero_zero_hash_zero);
  tcase_add_test(tc, test_s21_sprintf_g_zero_width_zero_zero);
  tcase_add_test(tc, test_s21_sprintf_g_zero_prec_zero_minus_zero);
  tcase_add_test(tc, test_s21_sprintf_g_zero_prec_zero_plus_zero);
  tcase_add_test(tc, test_s21_sprintf_g_zero_prec_zero_space_zero);
  tcase_add_test(tc, test_s21_sprintf_g_zero_prec_zero_hash_zero);
  tcase_add_test(tc, test_s21_sprintf_g_zero_prec_width_zero_zero);
  tcase_add_test(tc, test_s21_sprintf_G_minus_negt);
  tcase_add_test(tc, test_s21_sprintf_G_minus_post);
  tcase_add_test(tc, test_s21_sprintf_G_minus_zero_);
  tcase_add_test(tc, test_s21_sprintf_G_minus_ng_z);
